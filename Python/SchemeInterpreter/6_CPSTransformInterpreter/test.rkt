...
;(define random-list (build-list 1000 (lambda (i) (random 1000))))
;(time-it (lambda () (sort random-list <)))

(define random-list-2 (build-list-cps 1000 (lambda (i) (random 1000)) identity))
(time-it (lambda () (sort-cps random-list-2 < identity)))
